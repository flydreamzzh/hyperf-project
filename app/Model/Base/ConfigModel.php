...
class ConfigModel extends BaseModel
{
     ...
     * @return array
     */
    public static function getConfigs($names = [])
    {
        $configs = [];
        if ($names) {
    ...
    /**
     * @param $name
     * @return \App\Core\Components\Builder|object|null
     */
    ...
    public function getFormatValue()
    {
        ...
        } else if (in_array($this->type, ['image', 'file'])) {
            if ($value) {
     ...
     * @return array
     */
    public static function getFormItems($group = null)
    {
        $value = [];
     ...
     */
    public function saveForType($value, $deleteOldFile = true)
    {
        $unlinkFile = null;
     ...
     * @param bool|integer $maxSize 最大值 KB
     * @return array
     */
    public function saveFileByUpload($FILES, $dir, $maxSize = false)
    {
