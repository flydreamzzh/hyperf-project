...
class AlarmService extends BaseService
{
    ...
    protected static function sendEmail($subject, $content)
    {
        ...
        $result = $email->setSubject($subject)
     ...
     * @return array
     */
    private static function setRedisHMSetData($name, $data)
    {
        $newData = [];
        ...
        $hmsetData = array_merge([$name], $newData);
        return $hmsetData;
    }
